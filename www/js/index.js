...
function getVerifiApiUrl() {
    return 'https://api.speaklabs.eu/api/verification_licences';
}

function getVerifiPurchaseApiUrl() {
    return 'https://api.speaklabs.eu/api/verification_purchases';
}
...
function getLogEventUri() {
    return 'https://api.speaklabs.eu/api/app_event_logs';
}
